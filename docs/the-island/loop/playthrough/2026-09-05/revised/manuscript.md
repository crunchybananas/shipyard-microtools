## The keeper’s working book

Voice: keeper. Artifact: keeper_logbook.
...
Voice: keeper. Artifact: signal_shelf.
...
## A letter in the coat

Voice: boatwright. Artifact: coat_letter.
...
Voice: founders. Artifact: stone_inscription.
...
## A note sent by water

Voice: boatwright. Artifact: bottle_note.
...
## The boatwright’s wax slate

Voice: boatwright. Artifact: kelp_slate.
...
## Pencil under the cairn

Voice: inspector. Artifact: bluff_cairn.
...
## Beside the unfinished boat

Voice: keeper. Artifact: source_note.
...
## The book beside the pillow

Voice: keeper. Artifact: quarters_journal.
...
## Writing beneath the reading glass

Voice: keeper. Artifact: lens_mark_study.
...
## On the smooth side of the stone

Voice: founders. Artifact: lens_mark_stone.
...
## Paper inside the little phial

Voice: keeper. Artifact: pool_phial.
...
## The visitor’s tide ledger

Voice: inspector. Artifact: drain_ledger.
...
## A recommendation, kept

Voice: inspector. Artifact: commendation_copy.
...
Voice: inspector. Artifact: closure_notice.
...
## A field slip under the stone

Voice: inspector. Artifact: field_slip.
...
## An offer, never burnt

Voice: inspector. Artifact: transfer_offer.
...
## In the model’s margin

Voice: keeper. Artifact: model_margin.
...
## A note inside the music box

Voice: keeper. Artifact: music_note.
...
## Under the spare chair

Voice: boatwright. Artifact: spare_place.
...
Voice: boatwright. Artifact: boat_return.
