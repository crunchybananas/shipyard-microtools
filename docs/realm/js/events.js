...
import { G, rng, rngInt } from './state.js?realm=180';
import { trySpawnSettlers } from './economy.js?realm=180';
import { sfx as playSound } from './log.js?realm=180';
import { emit } from './bus.js?realm=180';
import { chronicle, announce } from './log.js?realm=180';
import { recordDeathMarker } from './death-markers.js?realm=180';
import { removeCitizenFromWorld } from './citizen-ownership.js?realm=180';
