...
import { G, TILE, TW, TH, MAP_W, MAP_H, getDaylight } from './state.js?realm=177';
import { findPath, isWalkable, nearestWalkableTile } from './pathfinding.js?realm=177';
import { makeAtlasLoader } from './atlas-loader.js?realm=177';
import { citizenStaffingCapacity, staffingCount } from './citizen-ownership.js?realm=177';
import { buildCurrentCitizenPresentations } from './citizen-presentation.js?realm=177';
import { citizenRenderRecord } from './citizen-render-cache.js?realm=177';
...
import { playVoiceBark as _playBark } from './audio.js?realm=177';
let _lastBarkTick = 0;
...
import { playSound as _playSound129 } from './audio.js?realm=177';
