...
import { G, TILE, TW, TH, MAP_W, MAP_H, getDaylight } from './state.js?realm=181';
import { findPath, isWalkable, nearestWalkableTile } from './pathfinding.js?realm=181';
import { makeAtlasLoader } from './atlas-loader.js?realm=181';
import { citizenStaffingCapacity, staffingCount } from './citizen-ownership.js?realm=181';
import { buildCurrentCitizenPresentations } from './citizen-presentation.js?realm=181';
import { citizenRenderRecord } from './citizen-render-cache.js?realm=181';
...
import { playVoiceBark as _playBark } from './audio.js?realm=181';
let _lastBarkTick = 0;
...
import { playSound as _playSound129 } from './audio.js?realm=181';
