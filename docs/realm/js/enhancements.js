...
import { G, TILE, TW, TH, MAP_W, MAP_H, getDaylight } from './state.js?realm=183';
import { findPath, isWalkable, nearestWalkableTile } from './pathfinding.js?realm=183';
import { makeAtlasLoader } from './atlas-loader.js?realm=183';
import { citizenStaffingCapacity, staffingCount } from './citizen-ownership.js?realm=183';
import { buildCurrentCitizenPresentations } from './citizen-presentation.js?realm=183';
import { citizenRenderRecord } from './citizen-render-cache.js?realm=183';
...
import { playVoiceBark as _playBark } from './audio.js?realm=183';
let _lastBarkTick = 0;
...
import { playSound as _playSound129 } from './audio.js?realm=183';
