...
import { G, BUILDINGS, MAP_W, MAP_H, rng, rngInt, getSeasonData, getDayPeriod, getDifficulty, TILE } from './state.js?realm=167';
import { findPath, isWalkable, nearestWalkableTile } from './pathfinding.js?realm=167';
import { getCitizenSpeedMult } from './events.js?realm=167';
import { buildingCapacity } from './building-lifecycle.js?realm=167';
import { revealAround } from './world.js?realm=167';
