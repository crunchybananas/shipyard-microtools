...
import { G, BUILDINGS, MAP_W, MAP_H, rng, rngInt, getSeasonData, getDayPeriod, getDifficulty, TILE } from './state.js?realm=173';
import { findPath, isWalkable, nearestWalkableTile } from './pathfinding.js?realm=173';
import { getCitizenSpeedMult } from './events.js?realm=173';
import { buildingCapacity } from './building-lifecycle.js?realm=173';
import { revealAround } from './world.js?realm=173';
import { visualJitter } from './fx.js?realm=173';
import {
