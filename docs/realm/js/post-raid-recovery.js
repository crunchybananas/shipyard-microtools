...
import { G, BUILDINGS, MAP_H, MAP_W } from './state.js?realm=193';
import { isBuildingComplete, isBuildingOperational } from './building-operation.js?realm=193';
import { isFirstMusterComplete } from './first-muster.js?realm=193';
