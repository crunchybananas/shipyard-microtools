...
import { chronicle, initChronicle } from './log.js?realm=132';
...
import('./notifications.js?realm=132').then(m => { _NIGHTMARE_NOTIFY = m.notify; }).catch(() => {});
import('./audio.js?realm=132').then(m => { _PLAY_SOUND = m.playSound; }).catch(() => {});
