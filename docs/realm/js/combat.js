...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=181';
...
import { stepEntityToward } from './pathfinding.js?realm=181';
import { spawnClashFX, visualJitter } from './fx.js?realm=181';
...
import { sfx as playSound } from './log.js?realm=181';
import { removeBuilding } from './building-lifecycle.js?realm=181';
import { announce as notify } from './log.js?realm=181';
import { chronicle } from './log.js?realm=181';
import { recordDeathMarker } from './death-markers.js?realm=181';
import {
