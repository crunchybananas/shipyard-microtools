...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=174';
...
import { stepEntityToward } from './pathfinding.js?realm=174';
import { spawnClashFX, visualJitter } from './fx.js?realm=174';
...
import { sfx as playSound } from './log.js?realm=174';
import { removeBuilding } from './building-lifecycle.js?realm=174';
import { announce as notify } from './log.js?realm=174';
import { chronicle } from './log.js?realm=174';
import { recordDeathMarker } from './death-markers.js?realm=174';
import {
