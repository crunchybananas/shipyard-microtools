...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=176';
...
import { stepEntityToward } from './pathfinding.js?realm=176';
import { spawnClashFX, visualJitter } from './fx.js?realm=176';
...
import { sfx as playSound } from './log.js?realm=176';
import { removeBuilding } from './building-lifecycle.js?realm=176';
import { announce as notify } from './log.js?realm=176';
import { chronicle } from './log.js?realm=176';
import { recordDeathMarker } from './death-markers.js?realm=176';
import {
