...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=170';
...
import { stepEntityToward } from './pathfinding.js?realm=170';
import { spawnClashFX, visualJitter } from './fx.js?realm=170';
...
import { sfx as playSound } from './log.js?realm=170';
import { removeBuilding } from './building-lifecycle.js?realm=170';
import { announce as notify } from './log.js?realm=170';
import { chronicle } from './log.js?realm=170';
import { recordDeathMarker } from './death-markers.js?realm=170';
import {
