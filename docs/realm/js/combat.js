...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=175';
...
import { stepEntityToward } from './pathfinding.js?realm=175';
import { spawnClashFX, visualJitter } from './fx.js?realm=175';
...
import { sfx as playSound } from './log.js?realm=175';
import { removeBuilding } from './building-lifecycle.js?realm=175';
import { announce as notify } from './log.js?realm=175';
import { chronicle } from './log.js?realm=175';
import { recordDeathMarker } from './death-markers.js?realm=175';
import {
