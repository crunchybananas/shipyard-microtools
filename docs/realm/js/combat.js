...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=183';
...
import { stepEntityToward } from './pathfinding.js?realm=183';
import { spawnClashFX, visualJitter } from './fx.js?realm=183';
...
import { sfx as playSound } from './log.js?realm=183';
import { removeBuilding } from './building-lifecycle.js?realm=183';
import { announce as notify } from './log.js?realm=183';
import { chronicle } from './log.js?realm=183';
import { recordDeathMarker } from './death-markers.js?realm=183';
import {
