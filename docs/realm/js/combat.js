...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=171';
...
import { stepEntityToward } from './pathfinding.js?realm=171';
import { spawnClashFX, visualJitter } from './fx.js?realm=171';
...
import { sfx as playSound } from './log.js?realm=171';
import { removeBuilding } from './building-lifecycle.js?realm=171';
import { announce as notify } from './log.js?realm=171';
import { chronicle } from './log.js?realm=171';
import { recordDeathMarker } from './death-markers.js?realm=171';
import {
