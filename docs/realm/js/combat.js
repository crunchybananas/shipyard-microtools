...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=182';
...
import { stepEntityToward } from './pathfinding.js?realm=182';
import { spawnClashFX, visualJitter } from './fx.js?realm=182';
...
import { sfx as playSound } from './log.js?realm=182';
import { removeBuilding } from './building-lifecycle.js?realm=182';
import { announce as notify } from './log.js?realm=182';
import { chronicle } from './log.js?realm=182';
import { recordDeathMarker } from './death-markers.js?realm=182';
import {
