...
import { G, BUILDINGS, MAP_W, MAP_H, rng } from './state.js?realm=185';
...
import { stepEntityToward } from './pathfinding.js?realm=185';
import { spawnClashFX, visualJitter } from './fx.js?realm=185';
...
import { removeBuilding } from './building-lifecycle.js?realm=185';
import { announce as notify } from './log.js?realm=185';
import { chronicle } from './log.js?realm=185';
