...
import { G, BUILDINGS, MAP_W, MAP_H, TW, TH } from './state.js?realm=198';
import { screenToWorld, toScreen, toggleFPS } from './render.js?realm=198';
import { canAfford } from './economy.js?realm=198';
