...
import { G, MAP_W, MAP_H } from './state.js?realm=198';
import { sfx as playSound, announce } from './log.js?realm=198';
import { visualJitter } from './fx.js?realm=198';
import { depositFoodAcrossStores } from './building-inventory.js?realm=198';
