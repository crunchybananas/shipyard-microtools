import { G, BUILDINGS, MAP_W, MAP_H, rngRange, resourceEmoji, getDayPeriod } from './state.js?realm=130';
import { stepEntityToward, nearestWalkableTile } from './pathfinding.js?realm=130';
