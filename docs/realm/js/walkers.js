import { G, BUILDINGS, MAP_W, MAP_H, rngRange, resourceEmoji, getDayPeriod } from './state.js?realm=132';
import { stepEntityToward, nearestWalkableTile } from './pathfinding.js?realm=132';
