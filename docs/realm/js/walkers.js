import { G, BUILDINGS, MAP_W, MAP_H, rngRange, resourceEmoji, getDayPeriod } from './state.js?realm=135';
import { stepEntityToward, nearestWalkableTile } from './pathfinding.js?realm=135';
