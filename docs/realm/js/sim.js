...
import { G, MAP_W, MAP_H, updateSeason, getSeasonData } from './state.js?realm=133';
import { updateCitizens } from './citizens.js?realm=133';
import { updateAvatar } from './avatar.js?realm=133';
import { updateSoldiers } from './soldiers.js?realm=133';
import { updateEnemies, updateProjectiles, updateTowers } from './combat.js?realm=133';
import { updateWalkers } from './walkers.js?realm=133';
import { updateProduction, checkRaids, collectTaxes, updateFires } from './economy.js?realm=133';
import { checkMissions } from './missions.js?realm=133';
import { updateResearch, checkEraAdvance } from './tech.js?realm=133';
import { updateWonder } from './wonder.js?realm=133';
import { checkRandomEvents } from './events.js?realm=133';
import { checkScenarioComplete } from './scenarios.js?realm=133';
import { chronicle, announce, sfx } from './log.js?realm=133';
import { emit } from './bus.js?realm=133';
