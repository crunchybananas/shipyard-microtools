...
import { G, updateSeason, getSeasonData } from './state.js?realm=176';
import { updateCitizens } from './citizens.js?realm=176';
import { updateAvatar } from './avatar.js?realm=176';
import { updateSoldiers } from './soldiers.js?realm=176';
import { updateEnemies, updateProjectiles, updateTowers } from './combat.js?realm=176';
import { updateWalkers } from './walkers.js?realm=176';
import { updateProduction, checkRaids, collectTaxes, updateFires } from './economy.js?realm=176';
import { checkMissions } from './missions.js?realm=176';
import { updateResearch, checkEraAdvance } from './tech.js?realm=176';
import { updateWonder } from './wonder.js?realm=176';
import { checkRandomEvents } from './events.js?realm=176';
import { checkScenarioComplete } from './scenarios.js?realm=176';
import { chronicle, announce, sfx } from './log.js?realm=176';
import { emit } from './bus.js?realm=176';
import { checkStoryBeats } from './story.js?realm=176';
import { updateRaidSummary } from './raid-summary.js?realm=176';
