...
import { G, MAP_W, MAP_H, rng, rngRange, TILE } from './state.js?realm=182';
import { stepEntityToward, nearestWalkableTile } from './pathfinding.js?realm=182';
import { spawnClashFX } from './fx.js?realm=182';
