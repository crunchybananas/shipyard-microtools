...
import { G, MAP_W, MAP_H, rng, rngRange, TILE } from './state.js?realm=181';
import { stepEntityToward, nearestWalkableTile } from './pathfinding.js?realm=181';
import { spawnClashFX } from './fx.js?realm=181';
