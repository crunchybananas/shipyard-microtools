...
- 007 [code] — placement-preview grid contrast: the translucent green grid nearly disappears against grass tiles. Brighter edges, subtle pulse, or higher-contrast outline would make it discoverable. [render.js]
