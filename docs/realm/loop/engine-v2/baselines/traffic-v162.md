# Engine v2 Phase 0C traffic baseline (realm 162)

Captured 2026-07-12 from runtime revision `162`, simulation version `2`, and
content-addressed core order
`sha256:14621d8fcd8b94594989a9bc8b98e0e67c7f654687e80cdab8cafd940c19c014`.
The exact artifact is [`traffic-v162.json`](traffic-v162.json).
