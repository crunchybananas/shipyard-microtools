# Engine v2 Phase 0C traffic baseline (realm 163)

Captured 2026-07-12 from runtime revision `163`, simulation version `2`, and
content-addressed core order
`sha256:14621d8fcd8b94594989a9bc8b98e0e67c7f654687e80cdab8cafd940c19c014`.
The exact artifact is [`traffic-v163.json`](traffic-v163.json).
