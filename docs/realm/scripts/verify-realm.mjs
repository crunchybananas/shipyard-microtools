...
const checks = [
  ...
  ['continuous landscape and scenery depth', 'verify-landscape-browser.mjs'],
  ['connected road materials and construction', 'verify-road-material-browser.mjs'],
  ...
  ['Founder eight-direction walk', 'verify-founder-walk.mjs'],
  ['Founder Blender action agreement', 'verify-founder-actions.mjs'],
  ['Founder live material workshop', 'verify-founder-detail.mjs'],
  ['Founder gameplay integration', 'verify-founder-game.mjs'],
  ['Founder rendered settlement scale', 'verify-founder-scale.mjs'],
  ['Builder saved source and sprite maps', 'verify-builder-source.mjs'],
  ['Builder and settler gameplay family', 'verify-builder-game.mjs'],
  ['House saved source and construction maps', 'verify-house-source.mjs'],
  ['House construction, lighting and interaction', 'verify-house-game.mjs'],
  ['Retina citizen and building selection', 'verify-retina-world-picking.mjs'],
  ['Citizen displacement-driven gait', 'verify-citizen-locomotion.mjs'],
  ['Citizen world motion and traffic waits', 'verify-citizen-locomotion-browser.mjs'],
  ['Painted building and scenery ground contact', 'verify-ground-contacts-browser.mjs'],
  ['Building source ownership and winter surfaces', 'verify-building-surfaces-browser.mjs'],
  ['Source-aligned building lighting and actor depth', 'verify-building-lighting-browser.mjs'],
