...
import { G, BUILDINGS, MAP_H, MAP_W, createResourceStock, setSeed } from '../js/state.js?realm=178';
import { generateWorld } from '../js/world.js?realm=178';
import { placeBuilding, updateFires } from '../js/economy.js?realm=178';
import { buildingCapacity } from '../js/building-lifecycle.js?realm=178';
import { dispatch } from '../js/commands.js?realm=178';
import { updateEnemies } from '../js/combat.js?realm=178';
import { initChronicle } from '../js/log.js?realm=178';
import { prepareSave, serializeGame } from '../js/save-state.js?realm=178';
import {
