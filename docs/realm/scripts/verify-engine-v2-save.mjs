...
renderRecord.motion = { phase: 0.375, sentinel: 'motion-state-never-persist' };
...
assert.equal(compactText.includes('motion-state-never-persist'), false, 'distance-driven motion leaked into the save');
