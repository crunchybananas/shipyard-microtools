...
import { G, createResourceStock, setSeed } from '../js/state.js?realm=175';
import { generateWorld } from '../js/world.js?realm=175';
import { dispatch } from '../js/commands.js?realm=175';
import { canPlace } from '../js/economy.js?realm=175';
import { coreTick } from '../js/sim.js?realm=175';
import { renameCitizen } from '../js/citizen-ownership.js?realm=175';
import {
