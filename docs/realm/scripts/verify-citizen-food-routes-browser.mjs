...
assert.equal(contract.moduleRevision, 191, 'Update food-route browser imports with the runtime revision');
...
try {
  await page.goto(`${server.gameUrl}?v=citizen-food-routes-browser-191`);
