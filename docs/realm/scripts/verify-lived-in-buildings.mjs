...
import { placeBuilding, updateProduction } from '../js/economy.js?realm=196';
...
import { isBuildingOperational } from '../js/building-operation.js?realm=196';
import { depositFood, storedFood, withdrawFood } from '../js/building-inventory.js?realm=196';
