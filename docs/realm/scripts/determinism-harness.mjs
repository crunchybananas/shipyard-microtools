...
import runtimeContract from '../runtime-contract.json?realm=170' with { type: 'json' };
import {
  ...
  getSeed,
  setSeed,
} from '../js/state.js?realm=170';
import { generateWorld } from '../js/world.js?realm=170';
import { CORE_SYSTEM_ORDER, coreStateIdentity, coreTick } from '../js/sim.js?realm=170';
import { commandStateIdentity, dispatch } from '../js/commands.js?realm=170';
import { canPlace } from '../js/economy.js?realm=170';
