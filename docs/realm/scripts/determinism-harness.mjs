...
import { CORE_SYSTEM_ORDER, coreStateIdentity, coreTick } from '../js/sim.js?realm=196';
import { commandStateIdentity, dispatch } from '../js/commands.js?realm=196';
...
export function runDeterminismScenario({
  ...
  return strictCanonicalize({
    ...
    changedCommandState: {
      ...
      armyGuardPoint: G.armyGuardPoint,
