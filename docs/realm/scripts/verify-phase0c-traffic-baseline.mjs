...
import {
  ...
  createResourceStock,
  setSeed,
} from '../js/state.js?realm=186';
import {
  findPath,
  getPathfindingDiagnostics,
} from '../js/pathfinding.js?realm=186';
import { updateCitizens } from '../js/citizens.js?realm=186';
import { updateSoldiers } from '../js/soldiers.js?realm=186';
import { updateWalkers } from '../js/walkers.js?realm=186';
import { updateAnimals } from '../js/animals.js?realm=186';
import {
  createCitizenOwnership,
  resetCitizenOwnershipRuntime,
  transitionCitizenActivity,
} from '../js/citizen-ownership.js?realm=186';
import { buildCitizenPresentation } from '../js/citizen-presentation.js?realm=186';

const RECORDED_REVISION = 186;
