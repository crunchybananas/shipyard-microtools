...
import runtimeContract from '../runtime-contract.json?realm=172' with { type: 'json' };
import {
  G,
  MAP_H,
  MAP_W,
  ...
  createResourceStock,
  setSeed,
} from '../js/state.js?realm=172';
import {
  findPath,
  getPathfindingDiagnostics,
} from '../js/pathfinding.js?realm=172';
import { updateCitizens } from '../js/citizens.js?realm=172';
import { updateSoldiers } from '../js/soldiers.js?realm=172';
import { updateWalkers } from '../js/walkers.js?realm=172';
import { updateAnimals } from '../js/animals.js?realm=172';
import {
  createCitizenOwnership,
  resetCitizenOwnershipRuntime,
  transitionCitizenActivity,
} from '../js/citizen-ownership.js?realm=172';
import { buildCitizenPresentation } from '../js/citizen-presentation.js?realm=172';

const RECORDED_REVISION = 172;
