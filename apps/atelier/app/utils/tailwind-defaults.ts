/**
 * Default Tailwind v3 mappings.
 *
 * Maps CSS values → Tailwind utility class suffixes.
 * Colors are stored as hex → suffix (e.g., '#818cf8' → 'indigo-400').
 * The export utility prepends the property prefix (bg-, text-, border-).
 */

// Tailwind v3 default color palette (hex → class suffix)
...
export const TAILWIND_BORDER_RADIUS: Record<number, string> = {
  0: "rounded-none",
  2: "rounded-sm",
  4: "rounded",
  6: "rounded-md",
...
export const TAILWIND_FONT_SIZE: Record<number, string> = {
  12: "text-xs",
  14: "text-sm",
  16: "text-base",
  18: "text-lg",
...
export const TAILWIND_FONT_WEIGHT: Record<string, string> = {
  "100": "font-thin",
  "200": "font-extralight",
  "300": "font-light",
  "400": "font-normal",
...
// Opacity: 0-1 value → Tailwind class
...
// Stroke width / border width: px → Tailwind class
export const TAILWIND_BORDER_WIDTH: Record<number, string> = {
  0: "border-0",
  1: "border",
  2: "border-2",
  4: "border-4",
